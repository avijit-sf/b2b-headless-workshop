...
import { ROUTES, AUTH_PLACEHOLDERS } from "@/config/auth";
import { emailSchema, passwordSchema, getStartUrl, type AuthResponse } from "@/lib/authHelpers";
import { handleApiResponse, getErrorMessage } from "@/lib/authResponseHelpers";
